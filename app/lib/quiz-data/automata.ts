...
export const automataQuestions: QuizQuestion[] = [
    {
        ...
        references: [
            { label: "Wikipedia: Chomsky Hierarchy", url: "https://en.wikipedia.org/wiki/Chomsky_hierarchy" },
        ],
    },
    {
        id: "flat-2",
        topic: "automata",
        prompt: "The language accepted by a Pushdown Automaton (PDA) belongs to which type in the Chomsky hierarchy?",
    ...
    },
    {
        id: "flat-3",
        topic: "automata",
        prompt: "All regular languages can be described by which of the following representations?",
        options: ["DFA, NFA, and Regular Expressions only", "DFA, NFA, and ε-NFA only", "DFA and Regular Expressions only", "DFA, NFA, ε-NFA, and Regular Expressions"],
        answerIndex: 3,
        explanation:
    ...
    },
    {
        id: "flat-4",
        topic: "automata",
        prompt: "Recursively enumerable languages are NOT closed under which operation?",
        ...
        references: [
            { label: "Wikipedia: Recursively Enumerable Language", url: "https://en.wikipedia.org/wiki/Recursively_enumerable_language" },
        ],
    },
    {
        id: "flat-5",
        topic: "automata",
        prompt: "If all production rules have a single non-terminal symbol on the left side, the grammar is called:",
        options: ["Context Free Grammar", "Context Sensitive Grammar", "Unrestricted Grammar", "Phrase Grammar"],
        answerIndex: 0,
        explanation:
    ...
    },
    {
        id: "flat-6",
        topic: "automata",
        prompt: "A grammar whose productions are of the form A → BC is in which normal form?",
        options: ["Chomsky Normal Form", "Greibach Normal Form", "Both CNF and GNF", "Neither CNF nor GNF"],
        answerIndex: 0,
        explanation:
        ...
        references: [
            { label: "Wikipedia: Chomsky Normal Form", url: "https://en.wikipedia.org/wiki/Chomsky_normal_form" },
        ],
    },
    {
        id: "flat-7",
        topic: "automata",
        prompt: "Which technique can be used to prove that a language is non-regular?",
        options: ["Arden's Theorem", "Pumping Lemma", "Ogden's Lemma", "Both Pumping Lemma and Ogden's Lemma"],
        answerIndex: 1,
        explanation:
        ...
        references: [
            { label: "Wikipedia: Pumping Lemma", url: "https://en.wikipedia.org/wiki/Pumping_lemma_for_regular_languages" },
        ],
    },
    {
        id: "flat-8",
        topic: "automata",
        prompt: "Let N be an NFA with n states. Let k be the number of states of the minimal equivalent DFA. Which is necessarily true?",
        ...
        references: [
            { label: "Wikipedia: Powerset Construction", url: "https://en.wikipedia.org/wiki/Powerset_construction" },
        ],
    },
    {
        id: "flat-9",
        topic: "automata",
        prompt: "A language L is accepted by a Finite State Automaton (FSA) if and only if it is:",
        ...
        references: [
            { label: "Wikipedia: Finite Automaton", url: "https://en.wikipedia.org/wiki/Finite-state_machine" },
        ],
    },
    {
        id: "flat-10",
        topic: "automata",
        prompt: "Which of the following correctly represents the Chomsky hierarchy (most restrictive to least restrictive)?",
        options: ["REG ⊂ CFL ⊂ CSL ⊂ Type-0", "CFL ⊂ REG ⊂ Type-0 ⊂ CSL", "CSL ⊂ Type-0 ⊂ REG ⊂ CFL", "CSL ⊂ CFL ⊂ REG ⊂ Type-0"],
        answerIndex: 0,
        explanation:
    ...
    },
    {
        ...
        options: ["r(*) = r*", "(r*s*)* = (r+s)*", "(r+s)* = r* + s*", "r*s* = r* + s*"],
        answerIndex: 1,
        explanation:
        ...
        references: [
            { label: "Wikipedia: Regular Expression", url: "https://en.wikipedia.org/wiki/Regular_expression" },
        ],
    },
    {
        id: "flat-12",
        ...
        options: ["Left linear grammar", "Right linear grammar", "Generic grammar", "All of these"],
        answerIndex: 1,
        explanation:
        ...
        references: [
            { label: "Wikipedia: Regular Grammar", url: "https://en.wikipedia.org/wiki/Regular_grammar" },
        ],
    },
    {
        id: "flat-13",
        ...
        references: [
            { label: "Wikipedia: Context-Free Language", url: "https://en.wikipedia.org/wiki/Context-free_language" },
        ],
    },
    {
        id: "flat-14",
        ...
        references: [
            { label: "Wikipedia: Nondeterministic Finite Automaton", url: "https://en.wikipedia.org/wiki/Nondeterministic_finite_automaton" },
        ],
    },
    {
        id: "flat-15",
        ...
        options: ["Chomsky Normal Form", "Greibach Normal Form", "Backus-Naur Form", "All of the mentioned"],
        answerIndex: 1,
        explanation:
        ...
        references: [
            { label: "Wikipedia: Greibach Normal Form", url: "https://en.wikipedia.org/wiki/Greibach_normal_form" },
        ],
    },
    {
        id: "flat-16",
        topic: "automata",
        prompt: "What is the regular expression for the language L = {ε, ab, abab, ababab, ...}?",
    ...
    },
    {
        ...
        options: ["Concatenation (Dot operation)", "Union", "Kleene Star (Iteration)", "None — CFGs are closed under all of these"],
        answerIndex: 2,
        explanation:
            "Wait — CFGs ARE closed under union, concatenation, and Kleene star. However, they are NOT closed under intersection or complementation. The PDF answer indicates 'Iteration' (D) but this is a known error; CFGs are closed under Kleene star.",
        references: [
            { label: "Wikipedia: Context-Free Language", url: "https://en.wikipedia.org/wiki/Context-free_language" },
        ],
    },
    {
        id: "flat-18",
        topic: "automata",
        prompt: "If L1 and L2 are regular languages, then the concatenation L1.L2 is:",
        options: ["Regular", "Non-regular", "May be regular", "None of the mentioned"],
        answerIndex: 0,
        explanation:
            "Regular languages are closed under concatenation. If L1 and L2 are both regular, their concatenation L1.L2 is also regular.",
        references: [
            { label: "Wikipedia: Regular Language Closure Properties", url: "https://en.wikipedia.org/wiki/Regular_language#Closure_properties" },
        ],
    },
    {
        id: "flat-19",
        topic: "automata",
        prompt: "Consider: S1: Every context-sensitive language is recursive. S2: There exists a recursive language that is not context-sensitive. Which is correct?",
        options: [
        ...
        references: [
            { label: "Wikipedia: Context-Sensitive Language", url: "https://en.wikipedia.org/wiki/Context-sensitive_language" },
        ],
    },
    {
        id: "flat-20",
    ...
    },
    {
        id: "flat-21",
        topic: "automata",
        prompt: "A pushdown automaton behaves like a Turing machine when the number of auxiliary memory stacks is:",
    ...
    },
    {
        ...
        options: ["ε-production", "Unit production", "Symbol removal", "Zero production"],
        answerIndex: 0,
        explanation:
    ...
    },
    {
        id: "flat-23",
        topic: "automata",
        prompt: "Context-free languages are closed under which of the following operations?",
        options: ["Intersection only", "Complementation only", "Union and Kleene Star", "Intersection and Complementation"],
        answerIndex: 2,
        explanation:
    ...
    },
    {
        id: "flat-24",
        topic: "automata",
        prompt: "How many tuples are in the formal definition of a Finite State Machine?",
        ...
        references: [
            { label: "Wikipedia: Deterministic Finite Automaton", url: "https://en.wikipedia.org/wiki/Deterministic_finite_automaton" },
        ],
    },
    {
        id: "flat-25",
    ...
    },
    {
        id: "flat-27",
        topic: "automata",
        prompt: "Which language is NOT accepted by a Linear Bounded Automaton (LBA)?",
        ...
        references: [
            { label: "Wikipedia: Linear Bounded Automaton", url: "https://en.wikipedia.org/wiki/Linear_bounded_automaton" },
        ],
    },
    {
        id: "flat-28",
        ...
        references: [
            { label: "Wikipedia: Ambiguous Grammar", url: "https://en.wikipedia.org/wiki/Ambiguous_grammar" },
        ],
    },
    {
        id: "flat-29",
        topic: "automata",
        prompt: "The CFG S→XYX, X→aX|bX|λ, Y→bbb generates the language described by which regular expression?",
        options: ["(a+b)*bbb", "abbb(a+b)*", "(a+b)*(bbb)(a+b)*", "(a+b)(bbb)(a+b)*"],
        answerIndex: 2,
        explanation:
    ...
    },
    {
        id: "flat-30",
        topic: "automata",
        prompt: "The language of a Finite Automaton belongs to which type in the Chomsky hierarchy?",
        options: ["Type 0", "Type 1", "Type 2", "Type 3"],
        answerIndex: 3,
        explanation:
    ...
    },
    {
        ...
        references: [
            { label: "Wikipedia: Context-Free Language Closure", url: "https://en.wikipedia.org/wiki/Context-free_language" },
        ],
    },
    {
        id: "flat-34",
    ...
    },
    {
        ...
        references: [
            { label: "Wikipedia: Undecidable Problem", url: "https://en.wikipedia.org/wiki/Undecidable_problem" },
        ],
    },
    {
        id: "flat-36",
    ...
    },
    {
        ...
        options: ["Context-Free Language", "Recursively Enumerable Language", "Non-Regular Language", "Context-Sensitive Language"],
        answerIndex: 2,
        explanation:
    ...
    },
    {
        id: "flat-38",
        topic: "automata",
        prompt: "The regular expression for all strings that start with 'ab' and end with 'bba' is:",
    ...
    },
    {
        id: "flat-39",
        topic: "automata",
        prompt: "In converting NFA to DFA, which of the following statements is true?",
        options: [
    ...
    },
    {
        ...
        options: ["Regular language", "Context-sensitive language", "Context-free language", "Recursively enumerable language"],
        answerIndex: 2,
        explanation:
    ...
    },
    {
        id: "flat-41",
        topic: "automata",
        prompt: "The production of the form A → B, where A and B are non-terminals, is called:",
        options: ["ε-production", "Unit production", "Useless production", "Terminal production"],
        answerIndex: 1,
        explanation:
        ...
        references: [
            { label: "Wikipedia: Unit Production", url: "https://en.wikipedia.org/wiki/Context-free_grammar#Unit_production" },
        ],
    },
    {
        id: "flat-42",
        ...
        references: [
            { label: "Wikipedia: Formal Language", url: "https://en.wikipedia.org/wiki/Formal_language" },
        ],
    },
    {
        id: "flat-43",
        ...
        references: [
            { label: "Wikipedia: Finite-State Machine", url: "https://en.wikipedia.org/wiki/Finite-state_machine" },
        ],
    },
    {
        id: "flat-44",
        topic: "automata",
        prompt: "The Chomsky hierarchy classifies formal languages into how many levels?",
        options: ["2", "3", "4", "5"],
        answerIndex: 2,
        explanation:
    ...
    },
    {
        id: "flat-45",
        topic: "automata",
        prompt: "Which type of automaton has both a finite control unit and an unbounded tape?",
    ...
    },
    {
        id: "flat-46",
        topic: "automata",
        prompt: "The language accepted by a Turing machine with a halting state is known as:",
    ...
    },
    {
        ...
        options: ["Deterministic Finite Automaton", "Deterministic PDA", "Pushdown Automaton", "Deterministic Turing Machine"],
        answerIndex: 2,
        explanation:
    ...
    },
    {
        id: "flat-50",
        topic: "automata",
        prompt: "Which type of automaton is used in lexical analysis for tokenizing source code?",
        options: ["Pushdown Automaton", "Turing Machine", "Finite Automaton", "Linear Bounded Automaton"],
        answerIndex: 2,
        explanation:
    ...
    },
    {
        id: "flat-51",
        topic: "automata",
        prompt: "Which of the following conversions is NOT possible algorithmically?",
        options: [
    ...
    },
    {
        ...
        references: [
            { label: "Wikipedia: Pumping Lemma for Regular Languages", url: "https://en.wikipedia.org/wiki/Pumping_lemma_for_regular_languages" },
        ],
    },
    {
        id: "flat-53",
        topic: "automata",
        prompt: "Which of the following languages cannot be accepted by a regular grammar?",
        options: [
    ...
    },
    {
        id: "flat-54",
        topic: "automata",
        prompt: "If L1 and L2 are context-free languages, which of the following is also context-free?",
    ...
    },
    {
        id: "flat-55",
        topic: "automata",
        prompt: "Which of the following is not part of the 5-tuple definition of a finite automaton?",
    ...
    },
    {
        id: "flat-56",
        topic: "automata",
        prompt: "A regular expression for the language of all strings over {a,b} containing at least one 'a' is:",
    ...
    },
    {
        id: "flat-57",
        topic: "automata",
        prompt: "Which of the following statements about problems I–III is correct? (I) Membership in unrestricted grammar is undecidable. (II) Whether L(TM) is regular is undecidable. (III) Equivalence of two CFGs is undecidable.",
        options: [
    ...
    },
    {
        id: "flat-58",
        topic: "automata",
        prompt: "Suppose a regular language L is closed under the halving operation. The result (½L) will be:",
        options: ["¼L will be regular", "½L will be regular", "⅛L will be regular", "All of the mentioned"],
        answerIndex: 1,
        explanation:
        ...
        references: [
            { label: "Wikipedia: Regular Language Closure Properties", url: "https://en.wikipedia.org/wiki/Regular_language" },
        ],
    },
    {
        id: "flat-59",
        ...
        references: [
            { label: "Wikipedia: Useless Symbol (Formal Languages)", url: "https://en.wikipedia.org/wiki/Context-free_grammar" },
        ],
    },
    {
        id: "flat-60",
        topic: "automata",
        prompt: "The minimum number of states in any DFA accepting the language L = (111+11111)* is:",
        options: ["2", "3", "5", "6"],
        answerIndex: 1,
        explanation:
